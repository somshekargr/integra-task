...
output_2 += `
<tr>
<td>${facultyData.id}</td>
<td>${facultyData.login}</td>
<td><img src="${facultyData.id} alt=${facultyData.login} profile"/></td>
<td>${facultyData.url}</td>
</tr>
`;
document.getElementById('facultyBlock').innerHTML = output_2;
    }
